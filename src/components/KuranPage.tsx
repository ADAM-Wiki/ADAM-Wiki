        ...
        <section className="py-20 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h1 className="text-3xl font-serif font-medium">Kategorija: Kur'an</h1>
            </div>

            <div className="prose prose-invert max-w-none">
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  <h3 className="text-xl font-medium mb-4 text-white">Šta je Kur'an?</h3>
                  <p className="text-brand-dim leading-relaxed">
                    Kur'an je sveta knjiga islama koju muslimani veruju da je božanskog porekla.
                    U ovoj kategoriji istražujemo strukturu Kur'ana, njegove interpretacije, i
                    čuda koja se nalaze u Svetoj knjizi.
                  </p>
                </div>
                ...
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  ...
                  <ul className="text-brand-dim space-y-2">
                    <li>• Struktura Kur'ana</li>
                    <li>• Tafseer (interpretacija)</li>
                    <li>• Čuda Kur'ana</li>
                    <li>• Različiti precepti</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border-t border-white/5 pt-12">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {kuranArticles.map((article) => (
                    <div
                      key={article.slug}
                      onClick={() => navigate(`/kuran/article/${article.slug}`)}
