...
export default function RavnaZemjaArticlePage() {
  const { slug } = useParams<{ slug: string }>();
  const navigate = useNavigate();
  const article = ravnaZemjaArticles.find((item) => item.slug === slug);
