...
import { ateizmaArticles } from "../utils/articlesData";
...
export default function AteizmaPage() {
        ...
        <section className="py-20 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h1 className="text-3xl font-serif font-medium">Kategorija: Ateizma</h1>
            </div>

            <div className="prose prose-invert max-w-none">
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  <h3 className="text-xl font-medium mb-4 text-white">Šta je Ateizma?</h3>
                  <p className="text-brand-dim leading-relaxed">
                    Ateizma je odricanje postojanja boga ili bogova. U ovoj kategoriji istražujemo
                    različite aspekte ateizma, argumente koji se koriste u raspravama, i odnos između
                    ateizma i drugih gledišta.
                  </p>
                </div>
              ...
              <div className="border-t border-white/5 pt-12">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {ateizmaArticles.map((article) => (
                    <div
                      key={article.slug}
                      onClick={() => navigate(`/ateizma/article/${article.slug}`)}
