...
import { seriatArticles } from "../utils/articlesData";
...
export default function SeriatPage() {
        ...
        <section className="py-20 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center gap-4 mb-12">
              <span className="text-xs font-mono text-brand-dim">SERIAT</span>
              <h1 className="text-3xl font-serif font-medium">Kategorija: Šerijat</h1>
            </div>

            <div className="prose prose-invert max-w-none">
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  <h3 className="text-xl font-medium mb-4 text-white">Šta je Šerijat?</h3>
                  <p className="text-brand-dim leading-relaxed">
                    Šerijat je islamski pravni sistem zasnovan na Kur'anu i Sunnahu. U ovoj
                    kategoriji istražujemo osnove šerijata, njegovu primenu u društvu, i
                    različite interpretacije kroz istoriju.
                  </p>
                </div>
                ...
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  ...
                  <ul className="text-brand-dim space-y-2">
                    <li>• Osnove šerijata</li>
                    <li>• Porodica i brak</li>
                    <li>• Kazne i pravda</li>
                    <li>• Ekonomski zakoni</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border-t border-white/5 pt-12">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {seriatArticles.map((article) => (
                    <div
                      key={article.slug}
                      onClick={() => navigate(`/serijat/article/${article.slug}`)}
