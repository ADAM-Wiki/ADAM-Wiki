        ...
        <section className="py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-8 text-brand-dim leading-relaxed">
              <div>
                <h2 className="text-brand-heading font-medium mb-3">Upotreba sadržaja</h2>
              ...
              <div>
                <h2 className="text-brand-heading font-medium mb-3">Odgovornost</h2>
                <p>Trudimo se da svi podaci budu tačni i provereni. Čitaoci se pozivaju da sami provere navedene izvore.</p>
              </div>
              <div>
                <h2 className="text-brand-heading font-medium mb-3">Izmene</h2>
