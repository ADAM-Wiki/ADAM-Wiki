...
import {
  gethriscanstvoArticleBySlug,
  getAllhriscanstvoArticles,
} from "../lib/hriscanstvoArticles";
  ...
  return (
    <div className="min-h-screen bg-brand-bg relative selection:bg-brand-accent selection:text-brand-on-accent">
      <Helmet>
        ...
        <meta
          property="og:image"
          content={getOgImage("hriscanstvo", articleSlug)}
        />
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {relatedArticles.map((rel) => (
                      <div
                        ...
                        onClick={() => {
                          navigate(
                            `/categories/hriscanstvo/article/${rel.slug}`,
                          );
