...
import {
  istorijaMeta,
  type GeneratedIstorijaMeta,
} from "../lib/generated/istorijaMeta";
...
export default function IstorijaPage() {
  ...
  const articles: GeneratedIstorijaMeta[] = istorijaMeta;
  ...
  return (
    <div className="min-h-screen bg-brand-bg relative selection:bg-brand-accent selection:text-white">
      <Helmet>
        <title>Istorija | {SITE_NAME}</title>
        <meta
          name="description"
          content="Islamski istorijai i njihova naučna objašnjenja. Istražite autentične istorijae Poslanika Muhammeda s.a.v.s."
        />
        <meta property="og:title" content={`Istorija | ${SITE_NAME}`} />
        <meta
          property="og:description"
          content="Islamski istorijai i njihova naučna objašnjenja."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${SITE_URL}/categories/istorija`} />
        <meta
          property="og:image"
          content={`${SITE_URL}/images/og-default.jpg`}
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Istorija | ${SITE_NAME}`} />
        <meta
            ...
            <div className="prose prose-invert max-w-none">
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  ...
                  <p className="text-brand-dim leading-relaxed">
                    Istorija je izvještaj o riječima, postupcima ili odobrenjima
                    Poslanika Muhammeda (s.a.v.s.). Svaki istorija se sastoji od
                ...
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  ...
                  <ul className="text-brand-dim space-y-2">
                    <li>• Sahih - Autentični istorijai</li>
                    <li>• Hasan - Dobri istorijai</li>
                    <li>• Da'if - Slabi istorijai</li>
                    <li>• Maudhu' - Izmišljeni istorijai</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border-t border-white/5 pt-12">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 not-prose">
                  {paginatedArticles.map((article: GeneratedIstorijaMeta) => {
                    const hasWordCount =
                    ...
                    return (
                      <Link
                        key={article.slug}
                        to={`/categories/istorija/article/${article.slug}`}
