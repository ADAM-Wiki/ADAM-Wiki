...
import { ravnaZemjaArticles } from "../utils/articlesData";
...
export default function RavnaZemjaPage() {
        ...
        <section className="py-20 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center gap-4 mb-12">
              <span className="text-xs font-mono text-brand-dim">RAVNA ZEMLJA</span>
              <h1 className="text-3xl font-serif font-medium">Kategorija: Ravna Zemlja</h1>
            </div>

            <div className="prose prose-invert max-w-none">
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  <h3 className="text-xl font-medium mb-4 text-white">O Teoriji Ravne Zemlje</h3>
                  <p className="text-brand-dim leading-relaxed">
                    Teorija ravne zemlj je popularna teorija zavere koju neki ljudi veruju
                    uprkos naučnim dokazima. U ovoj kategoriji razmatramo istoriju ove teorije
                    i naučne dokaze koji je opovrgnjavaju.
                  </p>
                </div>
                ...
                <div className="p-6 border border-white/5 bg-white/[0.01] rounded-lg">
                  ...
                  <ul className="text-brand-dim space-y-2">
                    <li>• Istorija teorije</li>
                    <li>• Naučni dokazi</li>
                    <li>• Psihologija zavera</li>
                    <li>• Savremeni kontekst</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border-t border-white/5 pt-12">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {ravnaZemjaArticles.map((article) => (
                    <div
                      key={article.slug}
                      onClick={() => navigate(`/ravna-zemlja/article/${article.slug}`)}
