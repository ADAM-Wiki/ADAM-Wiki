...
export const odgovoriSearch: { slug: string; chunks: { text: string; headingId: string; headingText: string }[] }[] = [{"slug":"test-clanak","chunks":[{"text":"test","headingId":"","headingText":""}]}];
